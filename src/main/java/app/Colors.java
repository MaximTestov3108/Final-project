...
public class Colors {
     ...
     * Цвет разности
     */
    public static final int SUBTRACTED_COLOR = Misc.getColor(200, 255, 100, 255);
    /**
     * Цвет сетки
     */
    ...
    /**
     * Цвет обычных треугольников
     */
    public static final int TRIANGLE_COLOR = Misc.getColor(200, 240, 222, 60);
    /**
     * Цвет лучей
     */
