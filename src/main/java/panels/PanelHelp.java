...
public class PanelHelp extends GridPanel {
    ...
    public PanelHelp(
        ...
        shortcuts.add(new Shortcut("ЛКМ", false, "Добавление треугольников"));
        shortcuts.add(new Shortcut("ПКМ", false, "Добавление лучей"));
        shortcuts.add(new Shortcut("R", false, "Сбросить задачу"));
        shortcuts.add(new Shortcut("S", false, "Решить задачу"));
    }
